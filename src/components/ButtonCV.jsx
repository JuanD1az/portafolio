...
export const ButtonCV = ({modal}) => {
  return (
    <a href="/cv.pdf" download="curriculum-juandiaz" className={`items-center justify-center py-1.5 px-4 font-medium rounded-3xl ${ modal ? "flex bg-white text-gray-900 text-lg" : "hidden md:flex text-gray-50 bg-black dark:bg-white dark:text-gray-900" } `}>
